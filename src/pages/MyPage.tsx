...
import OrderItem from "@/components/MyPage/OrderItem.tsx"; // 또는 적절한 경로
import { Address, Pet, Order } from '@/components/MyPage';
import OrderDetail from "@/components/MyPage/OrderDetail.tsx"; // 프로젝트 구조에 따라 경로를 조정하세요. (예: '../types' 또는 '@/types')
